...
componentWillUpdate: function(nextProps, nextState){
    ...
    // {
    //     if (nextProps.hour != this.state.hour || nextProps.minute != this.state.minute || nextProps.am != this.state.am){
    ...
    // },
        ...
        onTimeChanged: function onTimeChanged(hour, minute, am) {
            ...
            if (this.props.onChange != undefined) {
                var h =  am? hour: hour+12;
                let value = h+ ":" + minute;
                this.props.onChange({hour: hour, minute: minute, am:am, value:value, eventId: this.props.eventId});
            }
        ...
        render: function render() {
            let key = "time" + this.props.eventId;
            return React.createElement(
                "div",
                { className: "time-picker" },
                React.createElement("input", { key:key, ref: "trigger", type: "text", readOnly: "true", value: _getTimeString(this.state.hour, this.state.minute, this.state.am), onClick: this.show }),
